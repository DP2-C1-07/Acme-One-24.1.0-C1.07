...
<acme:list navigable="true">
	...
	<acme:list-column code="any.claim.list.label.instantiation-moment" path="instantiationMoment" width="10%"/>
	...
	<acme:list-column code="any.claim.list.label.email-address" path="emailAddress" width="10%"/>
