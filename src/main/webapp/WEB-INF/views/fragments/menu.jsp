...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.developer" access="hasRole('Developer')">
			<acme:menu-suboption code="master.menu.developer.training-modules" action="/developer/training-module/list-mine"/>
		...
		<acme:menu-option code="master.menu.any">
			...
			<acme:menu-suboption code="master.menu.any.list-training-module" action="/any/training-module/list"/>
    	</acme:menu-option>
		...
		<acme:menu-option code="master.menu.sponsor" access="hasRole('Sponsor')">
			...
			<acme:menu-suboption code="master.menu.sponsor.my-invoices" action="/sponsor/invoice/list-mine"/>
